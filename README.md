...
| `forcing/hrrr_data_20210825_20210905_example/*.nc` | 2 | Daily HRRR NetCDF files covering the storm period |
...
(landfall ± 1 day, spatially cropped to the two sites used here). For
